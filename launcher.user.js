...
function getLatestCommit() {
    window.jQuery.ajax({
            url: "https://api.github.com/repos/apostolique/agarpy.com-bot/git/refs/heads/master",
            cache: false,
            dataType: "jsonp"
        }).done(function(data) {
            ...
            window.jQuery.get('https://raw.githubusercontent.com/Apostolique/agarpy.com-bot/master/launcher.user.js?' + Math.floor((Math.random() * 1000000) + 1), function(data) {
                ...
                if (latestVersion > myVersion) {
                    update("aposLauncher", "launcher.user.js", "https://github.com/Apostolique/agarpy.com-bot/blob/" + sha + "/launcher.user.js/");
                }
...
(function(d, e) {
    ...
    function Pa() {
        ...
        e.get("https://m.agarpy.com/info", function(a) {
                var b = {},
                    c;
                for (c in a.regions) {
                    var l = c.split(":")[0];
    ...
    function Za() {
        ...
        e.ajax("https://m.agarpy.com/findServer", {
            error: function() {
                setTimeout(Za, 1E3)
            },
            success: function(b) {
    ...
    function Ca(a, b) {
        ...
        if (tb) {
            var d = a.split(":");
            a = d[0] + "s://ip-" + d[1].replace(/\./g, "-").replace(/\//g, "") + ".tech.agarpy.com:" + (+d[2] + 2E3)
        }
        M = [];
        k = [];
        E = {};
    ...
    function La(a) {
        if ("connected" == a.status) {
            ...
            e("#helloContainer").attr("data-logged-in", "1");
            null != B ? e.ajax("https://m.agarpy.com/checkToken", {
                error: function() {
                ...
                crossDomain: !0,
                data: B
            }) : e.ajax("https://m.agarpy.com/facebookLogin", {
                error: function() {
    ...
    function Wa(a) {
        ...
        e.ajax(Na + "//m.agarpy.com/getToken", {
            error: function() {
                e("#helloContainer").attr("data-party-state", "6")
            },
            success: function(b) {
                b = b.split("\n");
                e(".partyToken").val("agarpy.com/#" +
    ...
    if (!d.agarioNoInit) {
        ...
        if (-1 != xa.indexOf("Android")) d.ga && d.ga("send", "event", "MobileRedirect", "PlayStore"), setTimeout(function() {
                d.location.href = "market://details?id=com.miniclip.agarpy.com"
            },
            1E3);
            ...
            d.location.href = "https://itunes.apple.com/app/agarpy.com/id995999703"
        }, 1E3);
        else {
            ...
            if ("undefined" == typeof console || "undefined" ==
                ...
                e.get(Na + "//gc.agarpy.com", function(a) {
                    var b = a.split(" ");
                    a = b[0];
                ...
                d.createParty = function() {
                    ...
                    L = function(a) {
                        Ma("/#" + d.encodeURIComponent(a));
                        e(".partyToken").val("agarpy.com/#" + d.encodeURIComponent(a));
