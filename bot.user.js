...
function getLatestCommit() {
    window.jQuery.ajax({
            ...
            $.get('https://raw.githubusercontent.com/Apostolique/agarpy.com-bot/master/bot.user.js?' + Math.floor((Math.random() * 1000000) + 1), function(data) {
                ...
                {
                    update("aposBot", "bot.user.js", "https://github.com/Apostolique/agarpy.com-bot/blob/" + sha + "/bot.user.js/");
                }
